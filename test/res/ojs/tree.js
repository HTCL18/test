...
(function ($) {
    ...
    $.fn.treeview = function (settings) {
        ...
        function buildnode(nd, ht, deep, path, isend) {
            ...
            if (deep == 1) {
                ht.push("<img class='bbit-tree-icon' src='/res/image/tree/s.gif'/>");
            }
            else if (deep > 1) {
                ht.push("<img class='bbit-tree-icon' src='/res/image/tree/s.gif'/>");
                for (var j = 1; j < deep; j++) {
                    ht.push("<img class='bbit-tree-elbow-line' src='/res/image/tree/s.gif'/>");
                }
            }
            ht.push("</span>");
            //img
            ...
            ht.push("<img class='bbit-tree-ec-icon ", cs.join(" "), "' src='/res/image/tree/s.gif'/>");
            var _img = "<img class='bbit-tree-node-icon' src='/res/image/tree/s.gif'/>";
            if (nd.img != undefined) {
